...
@OnlyIn(Dist.CLIENT)
public class FrugalAnvilScreen extends ContainerScreen<FrugalAnvilContainer> implements IContainerListener {
    private static final ResourceLocation ANVIL_RESOURCE = new ResourceLocation("textures/gui/container/anvil.png");
    private TextFieldWidget nameField;

    public FrugalAnvilScreen(FrugalAnvilContainer anvilContainer, PlayerInventory playerInventory, ITextComponent windowTitle) {
        super(anvilContainer, playerInventory, windowTitle);
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        int i = this.container.clientOnlyGetRepairCost();
        if (i > 0) {
            int j = 8453920;
            boolean flag = true;
